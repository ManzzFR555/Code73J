...
let handler = async (m, { conn, text }) => {
    if (db.data.chats[m.chat].isPrem == false && m.isGroup) throw global.nsfw


    if (!text) return m.reply("Pilih Salah Satu Dari Character Berikut:\n- yuuka\n- rpg\n- luffy\n- rias_gremory\n- akeno_aimejima\n- ash\n\nAtau Buat Custom Role Dengan Mengetikkan Perintah\n .rolegpt -c <role>\n\n akhiri sesi dengan\n\n .rolegpt -sesi");
    conn.sendMessage(m.chat);
    try {
        const filePath = './database/gpthistory.json';
        ...
        if (text.startsWith("-c" && !base)) {
            ...
            return m.reply("Pilih Salah Satu Dari Character Berikut:\n- yuuka\n- rpg\n- luffy\n- rias_gremory\n- akeno_aimejima\n- ash\n\nAtau Buat Custom Role Dengan Mengetikkan Perintah\n .rolegpt -c <role>\n\n akhiri sesi dengan\n\n .rolegpt -sesi")
        }
