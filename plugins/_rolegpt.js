...
export async function handler(chatUpdate) {
    ...
    try {
        ...
        if (opts["pconly"] && m.chat.endsWith("g.us"))
            return
        if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us') && !global.db.data.users[m.sender].premium && !global.db.data.users[m.sender].owner)

return this.sendMessage(m.chat, {
text: 🚩 Akses Bot Ke Private Chat Di Tolak, Silahkan Upgrade Premium Hanya 10.000 K Agar Bisa Bebas Akses Bot Dengan Hubungi Owner :\nWa.Me/${info.nomorown}\n\n• Join Ke Group Official Bot Untuk Free Akses & Informasi Kedepannya Tentang Bot : ${link.web}/${link.gc},
contextInfo: {
mentionedJid: [m.sender, owner],
externalAdReply: { showAdAttribution: false, 
title: Sorry Access Private Chat Denied!!,
body: wm,
thumbnailUrl: 'https://telegra.ph/file/0a623776465441671b2f4.jpg',
mediaType: 1,
...
const welran = await conn.profilePictureUrl(user, 'image')

const byeran = await conn.profilePictureUrl(id, 'image')

const welthum = "https://telegra.ph/file/70b32495dfc8a2d3a5841.png"

const byethum = "https://telegra.ph/file/260bab9f85a1c12b750ab.png"
...
await this.sendMessage(id, { 
   ...
   image: await (await fetch(welimg)).buffer(),
   ...
   contextInfo: { mentions: [participants[0]], externalAdReply: { title: global.wm, body: global.author, mediaType: 1, thumbnailUrl: isAddAction ? welthum : byethum, renderLargerThumbnail: true, sourceUrl: "https://처녀 사냥꾼" }}})
